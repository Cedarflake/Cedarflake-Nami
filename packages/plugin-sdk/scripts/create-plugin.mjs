...
const pluginKinds = {
  "analytics-sink": {
    ...
    registrationTarget: "i0c.runtime.config.ts",
    surface: "runtime",
  },
  "analytics-store": {
    category: "store",
    ...
    registrationTarget: "i0c.webui.config.ts",
    surface: "webui",
  },
  "data-repository": {
    category: "repository",
...
function createPackageJson(definition) {
  return {
    ...
    dependencies: {
      ...
      "@i0c/plugin-sdk": "workspace:*",
    },
    devDependencies: {
      "@i0c/plugin-testkit": "workspace:*",
      "@types/node": "^25.5.0",
      tsx: "^4.21.0",
      typescript: "^6.0.2",
    },
...
function createManifestSource(definition) {
  ...
  return `import { ${definition.kind.manifestHelper} } from "@i0c/plugin-sdk"
...
function createPluginSource(definition) {
  ...
  return `import { ${helperImport} } from "@i0c/plugin-sdk/${surface}"
...
function printHelp() {
  console.log(`Create an i0c compile-time plugin package.
...
Options:
  ...
  -n, --name <name>   Plugin package suffix in kebab-case
      --scope <scope> npm scope (default: @i0c)
